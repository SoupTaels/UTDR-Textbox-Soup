...
if ( file_dragging_face != -1 && result[? "id"] == file_dragging_face.sprite ) { //face
	...
	soupy_message(file_dragging_face.msg, snd_sparkle2, 70, 20);
	file_dragging_face = -1;
}

if ( file_dragging_bord != -1 && result[? "id"] == file_dragging_bord.sprite ) { //border
	...
	ui_message.is_destroyed = true;
	soupy_message(file_dragging_bord.msg, snd_sparkle2, 70, 20);
